# **МЕСТО ХРАНЕНИЯ КАСТОМНЫХ НАСТРОЕК И ГОРЯЧИХ КЛАВИШ ПРОГРАММ И ПРИЛОЖЕНИЙ КОТОРЫЕ ИСПОЛЬЗУЮ В РАБОТЕ `VS_CODE, JUPYTER, LINUX, GIT`**

## Используемые программы

![VSCode](https://img.shields.io/badge/vscode-IDLE-orange?logo=vscode&logoColor=white)  
...
![Git](https://img.shields.io/badge/git%20control%20version-007ACC?logo=git&logoColor=white)  
